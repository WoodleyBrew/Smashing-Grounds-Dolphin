...
curl -sL https://raw.githubusercontent.com/WoodleyBrew/Smashing-Grounds-Dolphin/$branch/Data/project-plus-dolphin.svg -o ./squashfs-root/project-plus-dolphin.svg
curl -sL https://raw.githubusercontent.com/WoodleyBrew/Smashing-Grounds-Dolphin/$branch/Data/project-plus-dolphin.desktop -o ./squashfs-root/project-plus-dolphin.desktop
...
curl -sL "https://raw.githubusercontent.com/WoodleyBrew/Smashing-Grounds-Dolphin/$branch/Distribution/appimage/update.sh" -o $HOME/squashfs-root/update.sh
curl -sL "https://raw.githubusercontent.com/WoodleyBrew/Smashing-Grounds-Dolphin/$branch/Distribution/appimage/AppRun" -o $HOME/squashfs-root/AppRun
